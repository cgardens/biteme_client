...
recipe = angular.module('MyRecipe', []);

recipe.controller('RecipeController', function($scope, $http) {
  $scope.loadRecipe = function() {
    $http({
      url: 'http://localhost:3000/recipes/search?term=tacos',
      method: 'get',
...
//     return $scope.directions[$scope.currentStep]
//   };
...
//       }
//     }
//   }; // needs to be tweaked to fit current recipe output
