// recipe = angular.module('MyRecipe', ['ngResource']);

// recipe.controller('RecipeController', function($scope, $http, $location) {
//   $http.get('http://localhost:3000/recipes/385013')
...
//     $scope.activateCaesar("caesar here, at your service. let's begin. your first step is: " + findStep());
//   };
